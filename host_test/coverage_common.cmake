...
macro(setup_gtest_coverage PROJECT_NAME EXECUTABLE_NAME)
    if(IDF_TARGET STREQUAL "linux")
        ...
        add_custom_target(generate_coverage
            ...
            COMMAND ${LCOV_PATH} --remove coverage_filtered.info "*/power_control/include/interfaces/*" --output-file coverage_filtered.info --rc branch_coverage=1 --ignore-errors mismatch,inconsistent,unused,empty
